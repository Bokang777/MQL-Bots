...
void CheckTrailingStop(double Ask){
      ...
      double SL = NormalizeDouble(Ask-800*_Point,_Digits);
      double SL2 = NormalizeDouble(Ask+800*_Point,_Digits);
      ...
      for (int i=PositionsTotal()-1; i>=0; i--){
         ...
         if (_Symbol==symbol){
            ...
            {
               //trade.PositionModify(PositionTicket,(CurrentStopLoss+500*_Point),Bid-500*_Point);
            }else if (CurrentStopLoss>SL2)
            {
               //trade.PositionModify(PositionTicket,(CurrentStopLoss-500*_Point),0);
            }     
            }}}
