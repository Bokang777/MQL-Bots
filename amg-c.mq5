...
//+------------------------------------------------------------------+
//--- inputs for expert
input string             Expert_Title           ="amg-c";     // Document name
ulong                    Expert_MagicNumber     =16496;       //
...
//--- Creating filter CSignalBearsPower
   CSignalBearsPower *filter1=new CSignalBearsPower;
   if(filter1==NULL)
     {
      //--- failed
...
//--- Set filter parameters
   filter1.PeriodBears(Signal_Vols_PeriodBears);
   filter1.Weight(Signal_Vols_Weight);
