...
//+------------------------------------------------------------------+
//--- inputs for expert
input string             Expert_Title                  ="adx";       // Document name
ulong                    Expert_MagicNumber            =23663;       //
...
//--- Creating filter CSignalADX
   CSignalADX *filter0=new CSignalADX;
   if(filter0==NULL)
     {
      //--- failed
...
//--- Set filter parameters
   filter0.PeriodADX(Signal_ADX_PeriodADX);
   filter0.Applied(Signal_ADX_Applied);
   filter0.Weight(Signal_ADX_Weight);
